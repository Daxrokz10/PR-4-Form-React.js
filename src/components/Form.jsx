...
const Form = () => {
  ...
  const handleForm = (e) => {
    ...
    if (!editId) {
      ...
      const data = list.map((val) => (val.id === editId ? { ...val, ...emp } : val));
      setList(data);
      setEditId(null);
    }
  ...
  const validation = () => {
    ...
    if (!emp.ename?.trim()) {
      errs.ename = "Name is required";
    }
    if (!emp.esalary) {
      errs.esalary = "Salary is required";
    }
    if (!emp.city?.trim()) {
            ...
            <form method='post' onSubmit={handleForm}>
              ...
              <div className="mb-3">
                ...
                <textarea
                  ...
                  onChange={handleInput}
                />
                {errors.address ? <div className='text-danger mt-1' style={{ fontSize: 13 }}>{errors.address}</div> : null}
              </div>
              ...
              <div className="mb-3">
                ...
                {errors.city ? <div className='text-danger mt-1' style={{ fontSize: 13 }}>{errors.city}</div> : null}
              </div>
